        ...
        <div class="col-sm-4 mymenu " >
            ...
            <ul  class="navbar-nav ">
                <li class="nav-item " ><a class="nav-link li" href="control.php">Control Panel</a></li>
                    <li class="nav-item " ><a class="nav-link li" href="add.php">Huawei ADD</a></li>
    ...
    <div class="row">
        <div class="col-4 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form role="form" method="post" action="add2.php" enctype="multipart/form-data"">
                        <fieldset>
                            <div class="form-group"  >
                                <input class="form-control" placeholder="Product Name" name="txtname" type="text" autofocus>
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="Product Price" name="txtprice" type="tetx" value="">
                            </div>
                            <div class="form-group">
...
if (isset($_POST['btnAdd']))
{
    ...
    {
            $q="INSERT INTO `samsung`( `name`, `price`, `image`) VALUES ('$name',$price,'$targetpath')";
